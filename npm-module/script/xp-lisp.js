...
exports.xpLisp = xpLisp;
exports.run = run;
exports.runAll = runAll;
const dntShim = __importStar(require("./_dnt.shims.js"));
const oml2ast_js_1 = require("./oml2ast.js");
const omlcommon_js_1 = require("./omlcommon.js");
const js_beautify_1 = __importDefault(require("js-beautify"));
const common = new omlcommon_js_1.OMLCommon();
function version() {
...
function xpLisp($g) {
    ...
    $g.compile_ast = (ast, debug) => {
        ...
        if (debug)
            console.log("[JAVASCRIPT]\n" + (0, js_beautify_1.default)(code) + "\n[/JAVASCRIPT]");
        return code;
    };
    $g.compile = (text, debug) => {
        const steps = (0, oml2ast_js_1.oml2ast)(text);
        let result = "";
    ...
    $g.exec = (exp, debug) => {
        const src = exp;
        const steps = (0, oml2ast_js_1.oml2ast)(src);
        let last;
        let text = "";
